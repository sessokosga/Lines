...
export const LEVELS: LevelData[] = [
    ...
    // --- SIZE 5x5 (Levels 4-6) ---
    {
        ...
        nodes: [
            ...
            { number: 5, row: 2, col: 2 },
            { number: 6, row: 1, col: 1 }
        ]
    },
    {
        id: 5, gridSize: 5,
        nodes: [
            { number: 1, row: 4, col: 0 },
            { number: 2, row: 0, col: 0 },
            { number: 3, row: 0, col: 4 },
            { number: 4, row: 2, col: 4 },
            { number: 5, row: 2, col: 0 },
            { number: 6, row: 4, col: 2 },
            { number: 7, row: 1, col: 2 }
        ]
    },
    {
        id: 6, gridSize: 5,
    ...
    // --- SIZE 6x6 (Levels 7-9) ---
    {
        ...
        nodes: [
            ...
            { number: 7, row: 2, col: 2 },
            { number: 8, row: 3, col: 3 },
            { number: 9, row: 0, col: 2 }
        ]
    },
    {
        id: 8, gridSize: 6,
        nodes: [
            { number: 1, row: 3, col: 0 },
            { number: 2, row: 0, col: 0 },
            { number: 3, row: 0, col: 5 },
            { number: 4, row: 5, col: 5 },
            { number: 5, row: 5, col: 0 },
            { number: 6, row: 2, col: 1 },
            { number: 7, row: 1, col: 4 },
            { number: 8, row: 4, col: 3 },
            { number: 9, row: 2, col: 4 },
            { number: 10, row: 0, col: 3 }
        ]
    },
    {
        id: 9, gridSize: 6,
        nodes: [
            ...
            { number: 2, row: 3, col: 0 },
            { number: 3, row: 0, col: 0 },
            { number: 4, row: 0, col: 5 },
            { number: 5, row: 5, col: 5 },
            { number: 6, row: 5, col: 0 },
            { number: 7, row: 3, col: 3 },
            { number: 8, row: 1, col: 1 },
            { number: 9, row: 4, col: 4 },
            { number: 10, row: 2, col: 2 },
            { number: 11, row: 0, col: 3 }
        ]
    },
    ...
    },
    {
        ...
        nodes: [
            ...
            { number: 6, row: 3, col: 6 },
            { number: 7, row: 1, col: 3 },
            { number: 8, row: 5, col: 3 },
            { number: 9, row: 2, col: 1 },
            { number: 10, row: 4, col: 5 },
            { number: 11, row: 0, col: 3 }
        ]
    },
    {
        id: 12, gridSize: 7,
        nodes: [
            { number: 1, row: 6, col: 3 },
            { number: 2, row: 3, col: 0 },
            { number: 3, row: 0, col: 0 },
            { number: 4, row: 0, col: 6 },
            { number: 5, row: 6, col: 6 },
            { number: 6, row: 6, col: 0 },
            { number: 7, row: 4, col: 1 },
            { number: 8, row: 1, col: 2 },
            { number: 9, row: 2, col: 5 },
            { number: 10, row: 5, col: 4 },
            { number: 11, row: 3, col: 3 },
            { number: 12, row: 0, col: 3 }
        ]
    }
];
